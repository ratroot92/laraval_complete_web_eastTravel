            ...
            <div class="banner_book_1">
                <ul>
                    <li class="dl2">Location :@if(count($cities)>1)
                        ...
                        @endforeach
                        @endif</li>
                    <li class="dl2">Price : €{{$activity->price}}</li>
                    <li class="dl2">Duration : {{$activity->duration}}</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container inn-page-con-bg tb-space">
            <div class="col-md-8 col-md-push">
                ...
                <div class="row">
                    ...
                    @php echo $activity->about@endphp
                </div>
                ...
                <div class="row">
                    ...
                    @php echo $activity->questions@endphp
                </div>
                <!--<div class="row p-t-10">-->
                <!--   <div class="col-md-12">-->
                <!--      <a type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;font-size:12px;"id="Btnpdf" href="{{asset::to('/activity/downloadPDF/').'/'.$activity->id}}">Download As PDF</a>-->
                <!--   </div>-->
                <!--</div>-->
                <!--====== TOUR LOCATION ==========-->
            ...
            <div class="col-md-4 col-md-pull tour_r">
                ...
                <div class="tour_right ">
                    ...
                    <div class="col-sm-6" style="padding: 1px;">
                        <a type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;font-size:12px; width: 100%" id="Btnpdf" href="{{asset::to('/activity/downloadPDF/').'/'.$activity->id}}">Download PDF</a>
                    </div>
                </div>
                ...
                <div class="tour_right tour_incl tour-ri-com">
                    ...
                    <ul>
                        <li>Tour Code: @php echo $activity->tourcode@endphp</li>
                        ...
                        <li>Group Size: @php echo $activity->grpsize@endphp</li>
                        <li>Tour Style: @php echo $activity->tourstyle@endphp</li>
                        <li>Tour Language: @php echo $activity->tourlanguage@endphp</li>
                        <li>Start/End Location: @php echo $activity->startloc@endphp</li>
                        <li>Availablity: @php echo $activity->avalibilitydetails@endphp</li>
                        <li>Transport Details: @php echo $activity->tranportdetails@endphp</li>
                        <li>Accomodation Details: @php echo $activity->accomodationdetails@endphp</li>
                        <li>Meal Details: @php echo $activity->mealdetails@endphp</li>
                        <li>Guide Details: @php echo $activity->guidedetails@endphp</li>
                    </ul>
                </div>
                ...
                <!--                        <td>Tour Code</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $activity->tourcode@endphp</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Location</td>-->
                <!--                        <td>:</td>-->
