...
<div class="container">
   <div class="row">
                        ...
                        <form>
                           <div id="cities">
                              <ul class="">
                                 <ul class="">
                                    <li>
                                       <a href="{{ url('/activities/grid') }}" style="padding:0px!important;margin:0px!important;color:white; border:none;">
                  ...
                  <div class="hot-page2-alp-l3 hot-page2-alp-l-com">
                     ...
                     <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
                        <form>
                           <div id="categories">
                              <ul class="">
                                 <li> <a href="{{ url('/activities/grid') }}" style="padding:0px!important;margin:0px!important;color:white; border:none;">
                                       <div class="checkbox checkbox-info checkbox-circle">
      ...
      <div class="col-md-9 " id="searchRendering">
         ...
         <a href="{{ url('/activity/detail')}}/{{$item->id}}">
            <div class="col-md-6 col-sm-6 col-xs-12 b_packages wow slideInUp" data-wow-duration="0.5s">
               ...
               <div class="b_pack rows">
                  ...
                  <div class="col-md-4 col-sm-4 pack_icon">
                     <ul>
                        <li>
                           <a href="{{ url('/activity/detail')}}/{{$item->id}}"><img src="{{asset('/theme/travel')}}/images/clock.png" alt="Date" title="Tour Timing" /> </a>
                        </li>
                        <li>
                           <a href="{{ url('/activity/detail')}}/{{$item->id}}"><img src="{{asset('/theme/travel')}}/images/info.png" alt="Details" title="View more details" /> </a>
                        </li>
                        <li>
                           <a href="{{ url('/activity/detail')}}/{{$item->id}}"><img src="{{asset('/theme/travel')}}/images/price.png" alt="Price" title="Price" /> </a>
                        </li>
                        <li>
                           <a href="{{ url('/activity/detail')}}/{{$item->id}}"><img src="{{asset('/theme/travel')}}/images/map.png" alt="Location" title="Location" /> </a>
                        </li>
                     </ul>
                  </div>
   ...
   $(document).ready(function() {
      ...
      $('#chp41').on('click', function() {
         if ($('#chp41').prop('checked')) {
            var city = $('#chp41').val();
            if (city != 'NA') {
               window.location.href = "{{asset::to('activities/gridsearch/city/')}}" + "/" + city;
            } else {
      ...
      $('#chp31').on('click', function() {
         if ($('#chp31').prop('checked')) {
            ...
            window.location.href = "{{asset::to('activities/gridsearch/country/')}}" + "/" + country;
      ...
      $('#chp21').on('click', function() {
         if ($('#chp21').prop('checked')) {
            ...
            window.location.href = "{{asset::to('activities/gridsearch/category/')}}" + "/" + category;
      ...
      $('#chp51').on('click', function() {
         if ($('#chp51').prop('checked')) {
            var price = $('#chp51').val();
            window.location.href = "{{asset::to('activities/gridsearch1/')}}" + "/" + price;
      ...
      $('#chp52').on('click', function() {
         if ($('#chp52').prop('checked')) {
            var price = $('#chp52').val();
            window.location.href = "{{asset::to('activities/gridsearch2/')}}" + "/" + price;
      ...
      $('#chp53').on('click', function() {
         if ($('#chp53').prop('checked')) {
            var price = $('#chp53').val();
            window.location.href = "{{asset::to('activities/gridsearch3/')}}" + "/" + price;
      ...
      $('#chp54').on('click', function() {
         if ($('#chp54').prop('checked')) {
            var price = $('#chp54').val();
            window.location.href = "{{asset::to('activities/gridsearch4/')}}" + "/" + price;
      ...
      $('#chp55').on('click', function() {
         if ($('#chp55').prop('checked')) {
            var price = $('#chp55').val();
            window.location.href = "{{asset::to('activities/gridsearch5/')}}" + "/" + price;
      ...
      $('#viewCheckbox1').on('click', function() {
         window.location.href = "{{asset::to('/activities/list')}}";
      });
      ...
      $('.countries').on('click', function() {
         ...
         window.location.href = "{{asset::to('activities/customsearch/country/')}}" + "/" + country;
      })
      $('#more_countries').hide();
      ...
      $('.categories').on('click', function() {
         ...
         window.location.href = "{{asset::to('activities/customsearch/category/')}}" + "/" + category;
      })
      ...
      $('.cities').on('click', function() {
         var city = $(this).val();
         window.location.href = "{{asset::to('activities/customsearch/city/')}}" + "/" + city;
      })
      $('#more_cities').hide();
