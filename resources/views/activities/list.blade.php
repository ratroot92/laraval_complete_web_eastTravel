   ...
   $(document).ready(function() {
      ...
      $('#chp51').on('click', function() {
         if ($('#chp51').prop('checked')) {
            var price = $('#chp51').val();
            window.location.href = "{{asset::to('activities/search1/')}}" + "/" + price;
      ...
      $('#chp52').on('click', function() {
         if ($('#chp52').prop('checked')) {
            var price = $('#chp52').val();
            window.location.href = "{{asset::to('activities/search2/')}}" + "/" + price;
      ...
      $('#chp53').on('click', function() {
         if ($('#chp53').prop('checked')) {
            var price = $('#chp53').val();
            window.location.href = "{{asset::to('activities/search3/')}}" + "/" + price;
      ...
      $('#chp54').on('click', function() {
         if ($('#chp54').prop('checked')) {
            var price = $('#chp54').val();
            window.location.href = "{{asset::to('activities/search4/')}}" + "/" + price;
      ...
      $('#chp55').on('click', function() {
         if ($('#chp55').prop('checked')) {
            var price = $('#chp55').val();
            window.location.href = "{{asset::to('activities/search5/')}}" + "/" + price;
      ...
      $('#viewCheckbox1').on('click', function() {
         window.location.href = "{{asset::to('/activities/grid')}}";
      });
