...
<div class="sb2-2">
    ...
    <div class="sb2-2-add-blog sb2-2-1">
                ...
                <form method="post" enctype="multipart/form-data" action="{{route('activity.edit')}}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="id" name="id" type="text" class="validate" value="{{$activity->id}}"
                                readonly="" />
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="name" name="name" type="text" value="{{$activity->name}}" class="validate"
                                required />
        ...
        <div class="row">
            <div class="input-field col s12">
                <input id="city" name="city" type="text" name="city" class="validate" value="{{$activity->city}}"
                    required/>
        ...
        <div class="row">
            <div class="input-field col s12 font-weight-bold">
                <input id="city" name="city" type="text"
                    value="@foreach($citynames as $item){{$item->name}},@endforeach" class="validate" required />
                <label for="city">City Name</label>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <input type="text" class="form-control" name="duration" id="duration" placeholder="5 Days"
                    value="{{$activity->duration}}" required />
        ...
        <div class="row">
            <div class="input-field col s12">
                <input type="text" name="grpsize" id="grpsize" class="validate" placeholder="Min:2 / Max:16"
                    minlength="2" maxlength="16" name="grpsize" value="{{$activity->grpsize}}" required="required" />
        ...
        <div class="row">
            <div class="input-field col s12">
                <input type="text" class="validate" placeholder="Vienna / Vienna " id="startloc" name="startloc"
                    value="{{$activity->startloc}}" required="required" />
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <input type="text" class="validate" id="tranportdetails" name="tranportdetails" required="required"
                    placeholder="Van" value="{{$activity->tranportdetails}}" />
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <input type="text" class="validate" id="tourlanguage" name="tourlanguage" placeholder="English"
                    value="{{$activity->tourlanguage}}" required="required" />
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <input type="text" class="validate" id="accomodationdetails" name="accomodationdetails"
                    placeholder="Included / Not included " value="{{$activity->accomodationdetails}}"
                    required="required" />
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <input type="text" class="validate" id="mealdetails" name="mealdetails"
                    placeholder="Included / Not included " value="{{$activity->mealdetails}}" required="required" />
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <input type="text" class="validate" id="guidedetails" name="guidedetails" required="required"
                    placeholder="Including English Speaker" value="{{$activity->guidedetails}}" />
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <input type="text" id="tourcode" class="validate" name="tourcode" required="required"
                    value="{{$activity->tourcode}}" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <input type="text" id="tourstyle" class="validate" name="tourstyle" value="{{$activity->tourstyle}}"
                    required="required" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <input type="text" id="avalibilitydetails" class="validate" name="avalibilitydetails"
                    required="required" value="{{$activity->avalibilitydetails}}" />
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <textarea id="destinations" class="ckeditor" name="destinations"
                    required="required">{{$activity->destinations}}</textarea>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12 font-weight-bold">
                <textarea id="day_detail" class="ckeditor" name="day_detail"
                    required="required">{{$activity->day_detail}}</textarea>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12 font-weight-bold">
                <textarea id="exclusion" class="ckeditor" name="exclusion"
                    required="required">{{$activity->exclusion}}</textarea>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12 font-weight-bold">
                <textarea id="inclusion" class="ckeditor" name="inclusion"
                    required="required">{{$activity->inclusion}}</textarea>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <textarea id="payment_policy" class="ckeditor" name="payment_policy"
                    required="required">{{$activity->payment_policy}}</textarea>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <textarea id="payment_methods" class="ckeditor" name="payment_methods"
                    required="required">{{$activity->payment_methods}}</textarea>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <textarea id="cancellation_policy" class="ckeditor" name="cancellation_policy"
                    required="required">{{$activity->cancellation_policy}}</textarea>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <textarea id="visa_info" class="ckeditor" name="visa_info"
                    required="required">{{$activity->visa_info}}</textarea>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                <textarea id="questions" class="ckeditor" name="questions"
                    required="required">{{$activity->questions}}</textarea>
            </div>
        </div>
        ...
        <div class="row">
            <div class="input-field col s12">
                <textarea id="" class="materialize-textarea" name="code" id="code"
                    ...
                    /required> {{$activity->code}}</textarea> <label for="textarea1">Code:</label>
            </div>
        </div>
        ...
        <div class="row">
            <div class="input-field col s12">
                <button type="submit" class="waves-effect waves-light btn-large">Update Activity<i
