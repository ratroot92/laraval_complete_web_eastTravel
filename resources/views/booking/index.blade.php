...
<head>
    ...
    <!-- FAV ICON -->
    <link rel="shortcut icon" href="{{url('/theme/travel')}}/images/fav.ico">
    <!-- GOOGLE FONTS -->
    ...
    <!--[if lt IE 9]>
    <script src="{{url('/theme/travel')}}/js/html5shiv.js"></script>
    <script src="{{url('/theme/travel')}}/js/respond.min.js"></script>
    <![endif]-->
</head>
    ...
    <div class="ed-mob-menu">
        <div class="ed-mob-menu-con">
            <div class="ed-mm-left">
                <div class="wed-logo">
                    <a href="main.html"><img src="{{url('/theme/admin')}}/images/logo.png" alt="" />
                    </a>
                </div>
            </div>
                                            ...
                                            <div class="mm1-com mm1-s1">
                                                <div class="ed-course-in">
                                                    <a class="course-overlay menu-about" href="all-package.html">
                                                        <img src="{{url('/theme/admin')}}/images/sight/5.jpg" alt="">
                                            ...
                                            <div class="mm2-com mm1-com mm1-s1">
                                                <div class="ed-course-in">
                                                    <a class="course-overlay" href="places.html">
                                                        <img src="{{url('/theme/admin')}}/images/sight/1.jpg" alt="">
                                            ...
                                            <div class="mm2-com mm1-com mm1-s1">
                                                <div class="ed-course-in">
                                                    <a class="course-overlay" href="places-1.html">
                                                        <img src="{{url('/theme/admin')}}/images/sight/2.jpg" alt="">
                                            ...
                                            <div class="mm2-com mm1-com mm1-s1">
                                                <div class="ed-course-in">
                                                    <a class="course-overlay" href="places-2.html">
                                                        <img src="{{url('/theme/admin')}}/images/sight/3.jpg" alt="">
                                            ...
                                            <div class="mm2-com mm1-com mm1-s4">
                                                <div class="ed-course-in">
                                                    <a class="course-overlay" href="places-3.html">
                                                        <img src="{{url('/theme/admin')}}/images/sight/4.jpg" alt="">
            ...
            <div class="col-md-8 col-sm-6 col-xs-12 testi-2">
                ...
                <div class="arrange">
                    <ul>
                        <!-- LOCATION MANAGER -->
                        <li>
                            <a href="#"><img src="{{url('/theme/admin')}}/images/Location-Manager.png" alt=""> </a>
                        </li>
                        <!-- PRIVATE GUIDE -->
                        <li>
                            <a href="#"><img src="{{url('/theme/admin')}}/images/Private-Guide.png" alt=""> </a>
                        </li>
                        <!-- ARRANGEMENTS -->
                        <li>
                            <a href="#"><img src="{{url('/theme/admin')}}/images/Arrangements.png" alt=""> </a>
                        </li>
                        <!-- EVENT ACTIVITIES -->
                        <li>
                            <a href="#"><img src="{{url('/theme/admin')}}/images/Events-Activities.png" alt=""> </a>
                        </li>
                    </ul>
                </div>
            </div>
...
<!--======== SCRIPT FILES =========-->
<script src="{{url('/theme/travel')}}/js/mail.js"></script>
