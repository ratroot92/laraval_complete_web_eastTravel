								...
								<form>
									...
									<div id="more_countries">
										<ul class="">
											...
											as $key=>$country)
											<div class="checkbox checkbox-info checkbox-circle">
												<input id="more_country{{$key}}" onClick="getCountryNameForSearch(this.value)" class="countries country styled" value="{{$country->name}}" type="checkbox">
				...
				<div>
					<div class="trav-ami">
						...
						<ul>
							...
							<li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img src="{{asset('public/images/icon/a18.png')}}" alt="">
							...
							<li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img src="https://image.flaticon.com/icons/png/512/84/84072.png" alt="">
							...
							<li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img src="http://simpleicon.com/wp-content/uploads/car.png" alt=""> <span>Transfer</span>
							</li>
							@else
							@endif
							@endforeach
							...
							<li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img src="http://cdn.onlinewebfonts.com/svg/img_528940.png" alt=""> <span>Flight</span>
							</li>
							@else
							@endif
							@endforeach
							...
							<li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img src="https://cdn1.iconfinder.com/data/icons/recreational-activities-1/64/16-512.png" alt="">
