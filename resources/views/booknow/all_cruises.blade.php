                        ...
                        <div class="hot-page2-alp-l3 hot-page2-alp-l-com">
                            ...
                            <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
                                <form>
                                            ...
                                            <li>
                                                <a href="/activities/list"
                                                    ...
                                                    <div class="checkbox checkbox-info checkbox-circle">
                                                        <input id="" class="cities city styled" value="all_cities"
                                                            type="checkbox">
                                                        <label for="">All Cities </label>
                                                    </div>
                                                </a>
                                            </li>
                                            @foreach($cities=DB::table('cities')->where('of','=','cruise')->orderBy('id','desc')->take(5)->get()->unique('name')
                                            as $key=>$city)
                                            <div>
                                                <input id="city{{$key}}" onClick="getCityNameForSearch(this.value)"
                                    ...
                                    <a href="javascript:void(0);" class="hot-page2-alp-p4-btn-s" id="more_city_btn">view
                                        more</a>
                                    <div id="more_cities">
                                        @foreach($cities=DB::table('cities')->where('of','=','cruise')->orderBy('id','desc')->skip(5)->take(100)->get()->unique('name')
                                        as $key=>$city)
                                        <div>
                                            <input id="city1{{$key}}" onClick="getCityNameForSearch(this.value)"
                                                value="{{$city->name}}" type="checkbox">
                                            <label for="city1{{$key}}">{{$city->name ?? 'NA'}} </label>
                                        </div>
                                        @endforeach
                                        <a href="javascript:void(0);" class="hot-page2-alp-p4-btn-s"
                                            id="less_city_btn">view less</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="hot-page2-alp-l3 hot-page2-alp-l-com">
                            ...
                            <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
                                <form>
                                        ...
                                        <ul class="">
                                            <li>
                                                <a href="/activities/list"
                                                    style="padding:0px!important;margin:0px!important;color:white; border:none;">
                                                    <div class="checkbox checkbox-info checkbox-circle">
                                                        <input id="" class="categories city styled"
                                                            value="all_categories" type="checkbox">
                                                        <label for="">All Categories </label>
                                                    </div>
                                                </a>
                                            </li>
                                            @foreach($categories=DB::table('categories')->where('of','=','cruise')->orderBy('id','desc')->take(5)->get()->unique('name')
                                            as $key=>$category)
                                            <div>
                                                <input id="category{{$key}}"
                                                    onClick="getCategoryNameForSearch(this.value)"
                                                    class="categories category styled" value="{{$category->name}}"
                                                    type="checkbox">
                                    ...
                                    <a href="javascript:void(0);" class="hot-page2-alp-p4-btn-s"
                                        id="more_category_btn">view more</a>
                                    <div id="more_categories">
                                        <ul class="">
                                            @foreach($categories=DB::table('categories')->where('of','=','cruise')->orderBy('id','desc')->skip(5)->take(100)->get()->unique('name')
                                            as $key=>$category)
                                            <div>
                                                <input id="more_category{{$key}}"
                                                    onClick="getCategoryNameForSearch(this.value)"
                                                    class="categories category styled" value="{{$category->name}}"
                                                    type="checkbox">
                                        ...
                                        <a href="javascript:void(0);" class="hot-page2-alp-p4-btn-s"
                                            id="less_category_btn">view less</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="hot-page2-alp-l3 hot-page2-alp-l-com">
                            ...
                            <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
                                <form>
                                        ...
                                        <ul class="">
                                            <li>
                                                <a href="/activities/list"
                                                    style="padding:0px!important;margin:0px!important;color:white; border:none;">
                                                    <div class="checkbox checkbox-info checkbox-circle">
                                                        <input id="" class="countries city styled" value="all_countries"
                                                            type="checkbox">
                                                        <label for="">All Countries </label>
                                                    </div>
                                                </a>
                                            </li>
                                            @foreach($counstries=DB::table('countries')->where('of','=','cruise')->orderBy('id','desc')->take(5)->get()->unique('name')
                                            as $key=>$country)
                                            <div class="checkbox checkbox-info checkbox-circle">
                                                <input id="country{{$key}}"
                                                    onClick="getCountryNameForSearch(this.value)"
                                                    class="countries country styled" value="{{$country->name}}"
                                                    type="checkbox">
                                    ...
                                    <a href="javascript:void(0);" class="hot-page2-alp-p4-btn-s"
                                        id="more_country_btn">view more</a>
                                    <div id="more_countries">
                                        <ul class="">
                                            @foreach($counstries=DB::table('countries')->where('of','=','cruise')->orderBy('id','desc')->skip(5)->take(100)->get()->unique('name')
                                            as $key=>$country)
                                            <div class="checkbox checkbox-info checkbox-circle">
                                                <input id="more_country{{$key}}"
                                                    onClick="getCountryNameForSearch(this.value)"
                                                    class="countries country styled" value="{{$country->name}}"
                                                    type="checkbox">
                                        ...
                                        <a href="javascript:void(0);" class="hot-page2-alp-p4-btn-s"
                                            id="less_country_btn">view less</a>
                                    </div>
                                </form>
                            </div>
                        </div>
