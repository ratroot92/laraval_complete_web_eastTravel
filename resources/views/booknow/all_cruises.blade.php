...
<div class="container">
    <div class="row">
                                ...
                                <form>
                                    <div id="cities">
                                        <ul class="">
                                            ...
                                            <div>
                                                <input id="city{{$city}}" onClick="getCityNameForSearch(this.value)"
                                                    value="{{$city}}" type="checkbox" />
                                                <label class="text-capitalize text-truncate"
                                                    for="city{{$city}}">{{$city}} </label>
                                            </div>
                                            @endforeach
                                            @else
                                            <p>No Cities</p>
                                    ...
                                    <div class="collapse" id="moreCitiesDiv">
                                        <div class="card card-body m-0 p-1">
                                            ...
                                            <div>
                                                <input id="city_more{{$more_city}}"
                                                    onClick="getCityNameForSearch(this.value)" value="{{$more_city}}"
                                                    type="checkbox" />
                                                <label class="text-capitalize text-truncate"
                                                    for="city_more{{$more_city}}">{{$more_city}} </label>
                                            </div>
                                            @endforeach
                                            @else
                                            <p>No More Cities</p>
                                ...
                                <form>
                                        ...
                                        <ul class="">
                                            ...
                                            <div>
                                                <input id="category{{$category}}"
                                                    ...
                                                    data-id="{{ $category }}" value="{{$category}}" type="checkbox">
                                                <label class="text-capitalize text-truncate"
                                    ...
                                    <div class="collapse" id="moreCategoriesDiv">
                                        <div class="card card-body m-0 p-1">
                                            ...
                                            <div>
                                                <input id="category_more{{$more_category}}"
                                                    onClick="getCategoryNameForSearch(this.value)"
                                                    value="{{$more_category}}" type="checkbox">
                                                <label class="text-capitalize text-truncate"
                                                    for="category_more{{$more_category}}">{{$more_category}} </label>
                                            </div>
                                            @endforeach
                                            @else
                                ...
                                <form>
                                        ...
                                        <ul class="">
                                            ...
                                            <div>
                                                <input id="country{{$country}}"
                                                    onClick="getCountryNameForSearch(this.value)" value="{{$country}}"
                                                    type="checkbox">
                                                <label class="text-capitalize text-truncate"
                                                    for="country{{$country}}">{{$country}} </label>
                                            </div>
                                            @endforeach
                                            @else
                                            <p>No Country</p>
                                    ...
                                    <div class="collapse" id="moreCountriesDiv">
                                        <div class="card card-body m-0 p-1">
                                            ...
                                            <div>
                                                <input id="country_more{{$more_country}}"
                                                    onClick="getCountryNameForSearch(this.value)"
                                                    value="{{$more_country}}" type="checkbox">
                                                <label class="text-capitalize text-truncate"
                                                    for="country_more{{$more_country}}">{{$more_country}} </label>
                                            </div>
                                            @endforeach
                                            @else
                                        ...
                                        <li>
                                            <div class="checkbox checkbox-info checkbox-circle">
                                                <input id="chp51" onClick="getPriceForSearch(this.value)"
                                                    class="price styled" value="250|0" type="checkbox">
        ...
        <div class="col-md-9 " id="searchRendering">
            <div class="row ">
                <div class="col-md-12 ">
                    <div class="radio-toolbar border-dark d-fle">
                        ...
                        <a class="custom_anchors" href="{{route('all_daytours')}}" id="daytours">Day Tours</a>
                        ...
                        <input type="radio" id="radioCruises" name="options" value="4" checked>
                        <a class="custom_anchors font-weight-bold" href="{{route('all_cruises')}}"
                            id="cruises">Cruises</a>
            ...
            <div class="row">
                <div class="col-md-12 alert alert-info font-weight-bold d-flex flex-row justify-content-start align-items-center text-capitalize"
                    id="message_div">
            ...
            <div class="row" style="border:1px solid #e9ecef;background-color: white!important;margin-bottom: 10px;">
                <div class="col-md-3 img-thumbnail  " style="padding:0px; margin:0px;border-radius:0px;">
                    ...
                    <img src="data:image/png;base64,"
                        width="100%" height="150px" alt="" style="padding:0px; margin:0px;">
                    @endif
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                    <div class="hot-page2-alp-ri-p3 tour-alp-ri-p3">
                        ...
                        <span class="hot-list-p3-1">From</span> <span
                            ...
                            <a href="{{ url('/cruise/detail') }}/{{$item->id}}" class="hot-page2-alp-quot-btn">Book
                                Now</a>
                        </span>
                    </div>
                </div>
                <div>
                    <div class="trav-ami">
                        ...
                        <ul>
                            ...
                            <li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img
                                    src="{{asset('public/images/icon/a14.png')}}" alt=""> <span>Sightseeing</span></li>
                            @else
                            @endif
                            @endforeach
                            @foreach($icons as $icon )
                            ...
                            <li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img
                                    src="{{asset('public/images/icon/a15.png')}}" alt=""> <span>Hotel</span></li>
                            @else
                            @endif
                            @endforeach
                            @foreach($icons as $icon)
                            ...
                            <li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img
                                    src="{{asset('public/images/icon/a16.png')}}" alt=""> <span>Transfer</span></li>
                            @else
                            @endif
                            @endforeach
                            @foreach($icons as $icon)
                            ...
                            <li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img
                                    src="{{asset('public/images/icon/a18.png')}}" alt="">
                            ...
                            <li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img
                                    src="{{asset('public/images/icon/a19.png')}}" alt="">
                            ...
                            <li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img
                                    src="https://image.flaticon.com/icons/png/512/84/84072.png" alt="">
                                <span>Breakfast</span></li>
                            @else
                            @endif
                            @endforeach
                            @foreach($icons as $icon )
                            ...
                            <li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img
                                    src="http://simpleicon.com/wp-content/uploads/car.png" alt=""> <span>Transfer</span>
                            </li>
                            @else
                            @endif
                            @endforeach
                            ...
                            <li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img
                                    src="https://www.pngrepo.com/png/193576/170/cruiser-war.png" alt="">
                            ...
                            <li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img
                                    src="http://cdn.onlinewebfonts.com/svg/img_528940.png" alt=""> <span>Flight</span>
                            </li>
                            @else
                            @endif
                            @endforeach
                            ...
                            <li href="{{ url('/cruise/detail') }}/{{$item->id}}"><img
                                    src="https://cdn1.iconfinder.com/data/icons/recreational-activities-1/64/16-512.png"
                                    alt="">
...
$(document).ready(function() {
    ...
    //global_data
    var type_name = "cruises";
    var cruises_count = "{{ count($cruises) }}"
    //end glocal data

    var url_array = window.location.pathname.split("/");
    var key2 = url_array[5];
    var key1 = url_array[4];
    if (url_array[3] == 'all_cruises') {


        console.log(cruises_count)
        $('#message_div').show();
        $('#message_div').empty().append(
            '<i class="fa fa-list-alt text-danger  fa-2x mr-5" aria-hidden="true"></i> found all ' +
            type_name + ' (' + cruises_count + ') <span class="font-weight-bold text-danger ml-2"></span>');
        ...
        if (url_array[4] == 'city') {
            ...
            $('#message_div').show();
            if (cruises_count == '0' || cruises_count == 0) {
                $('#message_div').empty().append(
                    '<i class="fa fa-list-alt text-danger  fa-2x mr-5" aria-hidden="true"></i> no  ' +
                    type_name + ' results for city <span class="font-weight-bold text-danger ml-2">' +
                    city_name + '</span>');
            } else {
            ...
            if (cruises_count == '0' || cruises_count == 0) {
                $('#message_div').empty().append(
                    '<i class="fa fa-list-alt text-danger  fa-2x mr-5" aria-hidden="true"></i> no ' +
                    type_name + ' results for country <span class="font-weight-bold text-danger ml-2">' +
                    country_name + '</span>');
            } else {
            ...
            if (cruises_count == '0' || cruises_count == 0) {
                $('#message_div').empty().append(
                    '<i class="fa fa-list-alt text-danger  fa-2x mr-5" aria-hidden="true"></i> no ' +
                    type_name + ' results for category <span class="font-weight-bold text-danger ml-2">' +
                    new_key2 + '</span>');
            } else {
            ...
            if (minprice == '250' && maxprice == '0') {
                ...
                if (cruises_count == '0' || cruises_count == 0) {
                    $('#message_div').empty().append(
                        '<i class="fa fa-list-alt text-danger  fa-2x mr-5" aria-hidden="true"></i> no   ' +
                        type_name +
                        ' results for price range  <span class="font-weight-bold text-danger ml-2">[ min price = ' +
                        minprice + ' &&  maxprice = ' + maxprice + ']</span>');
                } else {
                    $('#message_div').empty().append(
                        '<i class="fa fa-list-alt text-danger  fa-2x mr-5" aria-hidden="true"></i> found all ' +
                        type_name + ' (' + cruises_count +
                        ') results for price range  <span class="font-weight-bold text-danger ml-2">[ min price = ' +
                        minprice + ' &&  maxprice = ' + maxprice + ']</span>');
                }
