                     ...
                     <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
                        <form>
                           <div id="cities">
                              <ul class="" >
                                 <li>
                                    <a href="{{route('all_packages')}}" style="padding:0px!important;margin:0px!important;color:white; border:none;">
         ...
         <div class="row ">
            <div class="col-md-12 ">
               <div class="radio-toolbar border-dark d-fle">
                  ...
                  <a class="custom_anchors font-weight-bold" href="{{route('all_packages')}}" id="packages"   >Packages</a>
            ...
            <div>
               <div class="trav-ami">
                  ...
                  <ul>
                     ...
                     <li href="{{ url('/packages/detail') }}/{{$item->id}}"><img src="https://cdn1.iconfinder.com/data/icons/recreational-activities-1/64/16-512.png" alt="">
...
//global_data
var type_name="packages";
var packages_count="{{ count($packages) }}"
//end glocal data

            var url_array =window.location.pathname.split("/");
             var key2=url_array[5];
            var key1=url_array[4];
            if(url_array[3]=='all_packages'){


               console.log(packages_count)
               $('#message_div').show();
    $('#message_div').empty().append('<i class="fa fa-list-alt text-danger  fa-2x mr-5" aria-hidden="true"></i> found all '+type_name+' ('+packages_count+') <span class="font-weight-bold text-danger ml-2"></span>');
   ...
   if(url_array[4]=='city'){
    ...
    $('#message_div').show();
    if(packages_count == '0' || packages_count == 0){
...
$('#message_div').empty().append('<i class="fa fa-list-alt text-danger  fa-2x mr-5" aria-hidden="true"></i> no   '+type_name+' results for price range  <span class="font-weight-bold text-danger ml-2">[ min price = '+minprice+' &&  maxprice = '+maxprice+']</span>');
   ...
   $('#message_div').empty().append('<i class="fa fa-list-alt text-danger  fa-2x mr-5" aria-hidden="true"></i> found all '+type_name+' ('+packages_count+') results for price range  <span class="font-weight-bold text-danger ml-2">[ min price = '+minprice+' &&  maxprice = '+maxprice+']</span>');
  }
...
<script>
   $(document).ready(function (){
      $('#all_cities').on('click',function(){
        window.location.href = "{{URL::to('booknow/all_packages')}}";
      });
