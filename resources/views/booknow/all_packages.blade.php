								...
								<form>
									<div id="cities">
										<ul class="">
											...
											@foreach($cities=DB::table('cities')->where('of','=','package')->orderBy('id','desc')->take(5)->get()->unique('name') as $key=>$city)
											<div>
									...
									<div id="more_cities">
										@foreach($cities=DB::table('cities')->where('of','=','package')->orderBy('id','desc')->skip(5)->take(100)->get()->unique('name') as $key=>$city)
										<div>
								...
								<form>
									<div id="categories">
										<ul class="">
											...
											@foreach($categories=DB::table('categories')->where('of','=','package')->orderBy('id','desc')->take(5)->get()->unique('name') as $key=>$category)
											<div>
									...
									<div id="more_categories">
										<ul class="">
											@foreach($categories=DB::table('categories')->where('of','=','package')->orderBy('id','desc')->skip(5)->take(100)->get()->unique('name') as $key=>$category)
											<div>
								...
								<form>
									<div id="countries">
										<ul class="">
											...
											@foreach($counstries=DB::table('countries')->where('of','=','package')->orderBy('id','desc')->take(5)->get()->unique('name') as $key=>$country)
											<div class="checkbox checkbox-info checkbox-circle">
												<input id="country{{$key}}" class="countries country styled" value="{{$country->name}}" onClick="getCountryNameForSearch(this.value)" type="checkbox">
									...
									<div id="more_countries">
										<ul class="">
											@foreach($counstries=DB::table('countries')->where('of','=','package')->orderBy('id','desc')->skip(5)->take(100)->get()->unique('name') as $key=>$country)
											<div class="checkbox checkbox-info checkbox-circle">
