						...
						<form>
							<div id="cities">
								<ul class="" >
									...
									@foreach($cities=DB::table('cities')->where('of','=','transfer')->orderBy('id','desc')->take(5)->get()->unique('name') as $key=>$city)
									<div >
							...
							<div id="more_cities">
								@foreach($cities=DB::table('cities')->where('of','=','transfer')->orderBy('id','desc')->skip(5)->take(100)->get()->unique('name') as $key=>$city)
								<div >
									<input id="city{{$key}}"  value="{{$city->name}}" type="checkbox" >
									<label for="city{{$key}}">{{$city->name ?? 'NA'}} </label>
								</div>
						...
						<form>
							<div id="categories">
								<ul class="" >
									...
									@foreach($categories=DB::table('categories')->where('of','=','transfer')->orderBy('id','desc')->take(5)->get()->unique('name') as $key=>$category)
									<div >
							...
							<div id="more_categories">
								<ul class="" >
									@foreach($categories=DB::table('categories')->where('of','=','transfer')->orderBy('id','desc')->skip(5)->take(100)->get()->unique('name') as $key=>$category)
									<div >
					...
					<div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
						<form>
							<div id="countries">
								...
								@foreach($counstries=DB::table('countries')->where('of','=','transfer')->orderBy('id','desc')->take(5)->get()->unique('name') as $key=>$country)
								<div class="checkbox checkbox-info checkbox-circle">
						...
						<div id="more_countries">
							<ul class="" >
								@foreach($counstries=DB::table('countries')->where('of','=','transfer')->orderBy('id','desc')->skip(5)->take(100)->get()->unique('name') as $key=>$country)
								<div class="checkbox checkbox-info checkbox-circle">
