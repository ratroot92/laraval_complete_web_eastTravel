...
<div class="sb2-2-add-blog sb2-2-1">
    ...
    <div class="box-inn-sp">
        ...
        <div class="bor">
            ...
            <form method="post" action="{{route('cruise.insertcategory')}}">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        ...
                        <button type="submit" class="waves-effect waves-light btn-large">Create cruise Category <i class="fa fa-paper-plane"></i></button>
