          ...
          <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
            <form>
              <div id="cities">
                <ul class="" >
                 <li>
                      <a href="{{  url('/cruises/grid')}}" style="padding:0px!important;margin:0px!important;color:white; border:none;">   <div class="checkbox checkbox-info checkbox-circle">
...
var city=$('#chp41').val();
if(city!='NA'){
window.location.href = "{{URL::to('cruises/gridsearch/city/')}}"+"/"+city;
}
else{
}
...
window.location.href = "{{URL::to('cruises/gridsearch/country/')}}"+"/"+country;
...
window.location.href = "{{URL::to('cruises/gridsearch/category/')}}"+"/"+category;
...
var price=$('#chp51').val();
window.location.href = "{{URL::to('cruises/gridsearch1/')}}"+"/"+price;
...
var price=$('#chp52').val();
window.location.href = "{{URL::to('cruises/gridsearch2/')}}"+"/"+price;
...
var price=$('#chp53').val();
window.location.href = "{{URL::to('cruises/gridsearch3/')}}"+"/"+price;
...
var price=$('#chp54').val();
window.location.href = "{{URL::to('cruises/gridsearch4/')}}"+"/"+price;
...
var price=$('#chp55').val();
window.location.href = "{{URL::to('cruises/gridsearch5/')}}"+"/"+price;
...
window.location.href = "{{URL::to('/cruises/list')}}";
});
