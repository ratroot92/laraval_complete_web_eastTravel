              ...
              <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
                <form>
                  <div id="cities">
                    <ul class="">
                      <li>
                        <a href="{{  url('/cruises/grid')}}" style="padding:0px!important;margin:0px!important;color:white; border:none;">
                  ...
                  <div id="more_cities">
                    <ul class="">
                      @foreach($cities=DB::table('cities')->where('of','cruise')->orderBy('id','desc')->skip(5)->take(10)->distinct()->get() as $key=>$city)
                      @if($cities)
                      <li>
                        <div class="checkbox checkbox-info checkbox-circle">
            ...
            <div class="hot-page2-alp-l3 hot-page2-alp-l-com">
              ...
              <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
                <form>
                  <div id="categories">
                    <ul class="">
                      <li> <a href="{{  url('/cruises/grid')}}" style="padding:0px!important;margin:0px!important;color:white; border:none;">
                          <div class="checkbox checkbox-info checkbox-circle">
  ...
  $(document).ready(function() {
    ...
    $('#chp41').on('click', function() {
      if ($('#chp41').prop('checked')) {
        var city = $('#chp41').val();
        if (city != 'NA') {
          window.location.href = "{{asset::to('cruises/gridsearch/city/')}}" + "/" + city;
        } else {}
    ...
    $('#chp31').on('click', function() {
      if ($('#chp31').prop('checked')) {
        ...
        window.location.href = "{{asset::to('cruises/gridsearch/country/')}}" + "/" + country;
    ...
    $('#chp21').on('click', function() {
      if ($('#chp21').prop('checked')) {
        ...
        window.location.href = "{{asset::to('cruises/gridsearch/category/')}}" + "/" + category;
    ...
    $('#chp51').on('click', function() {
      if ($('#chp51').prop('checked')) {
        var price = $('#chp51').val();
        window.location.href = "{{asset::to('cruises/gridsearch1/')}}" + "/" + price;
    ...
    $('#chp52').on('click', function() {
      if ($('#chp52').prop('checked')) {
        var price = $('#chp52').val();
        window.location.href = "{{asset::to('cruises/gridsearch2/')}}" + "/" + price;
    ...
    $('#chp53').on('click', function() {
      if ($('#chp53').prop('checked')) {
        var price = $('#chp53').val();
        window.location.href = "{{asset::to('cruises/gridsearch3/')}}" + "/" + price;
    ...
    $('#chp54').on('click', function() {
      if ($('#chp54').prop('checked')) {
        var price = $('#chp54').val();
        window.location.href = "{{asset::to('cruises/gridsearch4/')}}" + "/" + price;
    ...
    $('#chp55').on('click', function() {
      if ($('#chp55').prop('checked')) {
        var price = $('#chp55').val();
        window.location.href = "{{asset::to('cruises/gridsearch5/')}}" + "/" + price;
    ...
    $('#viewCheckbox1').on('click', function() {
      window.location.href = "{{asset::to('/cruises/list')}}";
    });


    $('.countries').on('click', function() {
      var country = $(this).val();
      window.location.href = "{{asset::to('cruises/customsearch/country/')}}" + "/" + country;
    })
    $('#more_countries').hide();
    ...
    $('.categories').on('click', function() {
      ...
      window.location.href = "{{asset::to('cruises/customsearch/category/')}}" + "/" + category;
    })
    ...
    $('.cities').on('click', function() {
      var city = $(this).val();
      window.location.href = "{{asset::to('cruises/customsearch/city/')}}" + "/" + city;
    })
    $('#more_cities').hide();
