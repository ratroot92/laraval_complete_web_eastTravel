...
<strong>PHONE:</strong> +421-917-251-996
    ...
    <!--                <li><a href="#inner-page-title" class="bread-acti">{{$cruise->country ?? '' }}</a>-->
    <!--                </li>-->
    <!--            </ul>-->
    <!--            <h3 style="color: white">{{$cruise->name ?? ''}} </h3>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--</section>-->
    ...
    <!--                <ul>-->
    <!--                    <li class="dl2">Location : {{$cruise->city ?? ''}}, {{$cruise->country ?? '' }}</li>-->
    ...
    <section>
        ...
        <!--        <button type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;"id="Btnpdf" data-task={{$cruise->id ?? ''}}>Download As PDF</button>-->
        <!--    </div>-->
        <!--</div>-->
...
<!--                        </div>-->
                ...
                <!--====== TRIP INFORMATION ==========-->
                    <div class="tour_right tour_incl tour-ri-com">
                        ...
                        <ul>
                            <li>Location : {{$cruise->city ?? ''}}, {{$cruise->country ?? '' }}</li>
                            {{-- <li>Date: {{$cruise->date ?? '' }}</li> --}}
