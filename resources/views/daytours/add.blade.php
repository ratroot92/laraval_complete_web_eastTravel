...
<div class="bor">
    <form method="post" enctype="multipart/form-data" action="{{route('daytour.insert')}}">
        {{csrf_field()}}
        ...
        <div class="row">
            <div class="input-field col s12 font-weight-bold">
                ...
                <label for="name">Daytour Name</label>
            </div>
        </div>
...
<div class="row">
 ...
 <div class="row">
    <span class="alert alert-info ">select which icons should be visible in list view  </span>
        ...
        <div class="row">
            <div class="input-field col s12 font-weight-bold">
                <button type="submit" class="waves-effect waves-light btn-large">Create daytour<i class="fa fa-paper-plane"></i></button>
            </div>
        </div>
    </form>
