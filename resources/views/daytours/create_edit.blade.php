                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12">
                                <div class="file-field">
                                    ...
                                    @if($action == 'update')
                                        <div class="col-sm-3">
                                            <img class="img-thumbnail img-responsive" src="{{url(App\StoragePath::path().'/storage/sightseeing/'.$sightseeing_data[0]->banner)}}" alt="">
                                        </div>
                                        @endif
                                </div>
                                ...
                                <div class="input-field col s12">
                                    <div class="file-field">
                                        ...
                                        @if($action == 'update')
                                            <div class="col-sm-3">
                                                <img class="img-thumbnail img-responsive" src="{{url(App\StoragePath::path().'/storage/sightseeing/'.$sightseeing_data[0]->img_1)}}" alt="">
                                            </div>
                                ...
                                <div class="input-field col s12">
                                    <div class="file-field">
                                        ...
                                        @if($action == 'update')
                                            <div class="col-sm-3">
                                                <img class="img-thumbnail img-responsive" src="{{url(App\StoragePath::path().'/storage/sightseeing/'.$sightseeing_data[0]->img_2)}}" alt="">
                                            </div>
                                ...
                                <div class="input-field col s12">
                                    <div class="file-field">
                                        ...
                                        @if($action == 'update')
                                            <div class="col-sm-3">
                                                <img class="img-thumbnail img-responsive" src="{{url(App\StoragePath::path().'/storage/sightseeing/'.$sightseeing_data[0]->img_3)}}" alt="">
                                            </div>
                                ...
                                <div class="input-field col s12">
                                    ...
                                    @if($action == 'update')
                                        <div class="col-sm-3">
                                            <img class="img-thumbnail img-responsive" src="{{url(App\StoragePath::path().'/storage/sightseeing/'.$sightseeing_data[0]->img_4)}}" alt="">
                                        </div>
