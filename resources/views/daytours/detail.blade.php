...
@endif
                    ...
                    <!--   <div class="col-md-12">-->
                    <!--      <a type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;font-size:12px;"id="Btnpdf" href="{{URL::to('/daytour/downloadPDF/').'/'.$daytour->id}}">Download As PDF</a>-->
                    <!--   </div>-->
                    <!--</div>-->
                    <!--====== TOUR LOCATION ==========-->
