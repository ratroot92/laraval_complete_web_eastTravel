...
<!--====== BANNER ==========-->
<section>
    <div class="rows inner_banner" style="background-image: url('{{$daytour->banner}}');background-size: cover;">
        <!--<div class="container">-->
        <!--    <ul>-->
        ...
        <!--        </li>-->
        <!--    </ul>-->
        <!--    <h3 style="color: white">{{$daytour->name}} | @foreach($categories as $item){{$item->name}}/@endforeach</h3>-->
        <!--</div>-->
    </div>
</section>
            ...
            <div class="banner_book_1">
                <ul>
                    <li class="dl2">Location :@if(count($cities)>1)
                        ...
                        @endforeach
                        @endif</li>
                    <li class="dl2">Price : €{{$daytour->price}}</li>
                    <li class="dl2">Duration : {{$daytour->duration}}</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container inn-page-con-bg tb-space">
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    @php echo $daytour->day_detail@endphp
                </div>
                ...
                <div class="row">
                    ...
                    @php echo $daytour->payment_policy@endphp
                </div>
                <div class="row">
                    <h3>
                        <i class="fa fa-umbrella" style="background-color: darkorange;font-size: 20px"></i>
                    ...
                    @php echo $daytour->cancellation_policy@endphp
                </div>
                <div class="row">
                    <h3>
                        <i class="fa fa-umbrella" style="background-color: darkorange;font-size: 20px"></i>
                    ...
                    @php echo $daytour->visa_info@endphp
                </div>
                <div class="row">
                    <h3>
                        <i class="fa fa-umbrella" style="background-color: darkorange;font-size: 20px"></i>
                ...
                <div class="row">
                    ...
                    @php echo $daytour->questions@endphp
                </div>
                <!--<div class="row p-t-10">-->
                <!--   <div class="col-md-12">-->
                <!--      <a type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;font-size:12px;"id="Btnpdf" href="{{asset::to('/daytour/downloadPDF/').'/'.$daytour->id}}">Download As PDF</a>-->
                <!--   </div>-->
                <!--</div>-->
                <!--====== TOUR LOCATION ==========-->
            ...
            <div class="col-md-4 col-md-pull tour_r">
                ...
                <div class="tour_right ">
                    ...
                    <div class="col-sm-6" style="padding: 1px;">
                        <a type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;font-size:12px;width: 100%;" id="Btnpdf" href="{{asset::to('/daytour/downloadPDF/').'/'.$daytour->id}}">Download As PDF</a>
                    </div>
                </div>
                ...
                @php echo $daytour->code; @endphp

                <!--====== TRIP INFORMATION ==========-->
                <div class="tour_right tour_incl tour-ri-com">
                    <h3>Trip Information</h3>
                    <ul>
                        <li>Tour Code: @php echo $daytour->tourcode@endphp</li>
                        ...
                        <li>Duration: {{$daytour->duration}}</li>
                        <li>Group Size: @php echo $daytour->grpsize@endphp</li>
                        <li>Tour Style: @php echo $daytour->tourstyle@endphp</li>
                        <li>Tour Language: @php echo $daytour->tourlanguage@endphp</li>
                        <li>Start/End Location: @php echo $daytour->startloc@endphp</li>
                        <li>Availablity: @php echo $daytour->avalibilitydetails@endphp</li>
                        <li>Transport Details: @php echo $daytour->tranportdetails@endphp</li>
                        <li>Accomodation Details: @php echo $daytour->accomodationdetails@endphp</li>
                        <li>Meal Details: @php echo $daytour->mealdetails@endphp</li>
                        <li>Guide Details: @php echo $daytour->guidedetails@endphp</li>
                    </ul>
                </div>
                ...
                <!--                        <td>Tour Code</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $daytour->tourcode@endphp</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Location</td>-->
                <!--                        <td>:</td>-->
                ...
                <!--                        <td>Duration</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>{{$daytour->duration}}</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Group Size</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $daytour->grpsize@endphp</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Tour Style</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $daytour->tourstyle@endphp</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Tour Language</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $daytour->tourlanguage@endphp</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Start/End Location</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $daytour->startloc@endphp</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Availablity</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $daytour->avalibilitydetails@endphp</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Transport Details</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $daytour->tranportdetails@endphp</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Accomodation Details</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $daytour->accomodationdetails@endphp</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Meal Details</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $daytour->mealdetails@endphp</td>-->
                <!--                    </tr>-->
                <!--                    <tr>-->
                <!--                        <td>Guide Details</td>-->
                <!--                        <td>:</td>-->
                <!--                        <td>@php echo  $daytour->guidedetails@endphp</td>-->
                <!--                    </tr>-->
                <!--                </tbody>-->
                <!--            </table>-->
                <!--        </div>-->
