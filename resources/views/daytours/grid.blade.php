  ...
  <div class="rows inner_banner inner_banner_5">
    <div class="container">
      ...
      <ul>
        ...
        <li><a href="#inner-page-title" class="bread-acti">daytour</a>
        </li>
      </ul>
      <p>Book travel daytour and enjoy your holidays with distinctive experience</p>
    </div>
  </div>
</section>
<div class="container-fluid">
              ...
              <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
                <form>
                  <div id="cities">
                    <ul class="">
                      <li>
                        <a href="{{ url('/daytours/grid')}}" style="padding:0px!important;margin:0px!important;color:white; border:none;">
                  ...
                  <div id="more_cities">
                    <ul class="">
                      @foreach($cities=DB::table('cities')->where('of','daytour')->orderBy('id','desc')->skip(5)->take(10)->distinct()->get() as $key=>$city)
                      @if($cities)
                      <li>
                        <div class="checkbox checkbox-info checkbox-circle">
    ...
    <div class="col-md-9 " id="searchRendering">
      ...
      <a href="{{  url('/daytour/detail') }}/{{$item->id}}">
        <div class="col-md-6 col-sm-6 col-xs-12 b_packages wow slideInUp" data-wow-duration="0.5s">
          <!-- OFFER BRAND -->
          <!-- OFFER BRAND -->
          @if($item->disc!=0)<div class="band"> <img src="{{asset('/theme/travel')}}/images/icon/ribbon.png" alt="" />
            <span class="disc-text">{{$item->disc}}<br>OFF</span></div>
          @else
          <!--  <div class="band"> <img src="{{asset('/theme/travel')}}/images/icon/ribbon.png" alt="" /><span class="disc-text">No Discount</span></div> -->
          @endif
          <!--<div class="band">-->
          <!--    <div class="box">-->
          ...
          <div class="b_pack rows">
            ...
            <div class="col-md-4 col-sm-4 pack_icon">
              <ul>
                <li>
                  <a href="{{  url('/daytour/detail') }}/{{$item->id}}"><img src="{{asset('/theme/travel')}}/images/clock.png" alt="Date" title="Tour Timing" /> </a>
                </li>
                <li>
                  <a href="{{  url('/daytour/detail') }}/{{$item->id}}"><img src="{{asset('/theme/travel')}}/images/info.png" alt="Details" title="View more details" /> </a>
                </li>
                <li>
                  <a href="{{  url('/daytour/detail') }}/{{$item->id}}"><img src="{{asset('/theme/travel')}}/images/price.png" alt="Price" title="Price" /> </a>
                </li>
                <li>
                  <a href="{{  url('/daytour/detail') }}/{{$item->id}}"><img src="{{asset('/theme/travel')}}/images/map.png" alt="Location" title="Location" /> </a>
                </li>
              </ul>
            </div>
          </div>
  ...
  $(document).ready(function() {
    ...
    $('#chp41').on('click', function() {
      if ($('#chp41').prop('checked')) {
        var city = $('#chp41').val();
        if (city != 'NA') {
          window.location.href = "{{asset::to('daytours/gridsearch/city/')}}" + "/" + city;
        } else {}
    ...
    $('#chp31').on('click', function() {
      if ($('#chp31').prop('checked')) {
        ...
        window.location.href = "{{asset::to('daytours/gridsearch/country/')}}" + "/" + country;
    ...
    $('#chp21').on('click', function() {
      if ($('#chp21').prop('checked')) {
        ...
        window.location.href = "{{asset::to('daytours/gridsearch/category/')}}" + "/" + category;
    ...
    $('#chp51').on('click', function() {
      if ($('#chp51').prop('checked')) {
        var price = $('#chp51').val();
        window.location.href = "{{asset::to('daytours/gridsearch1/')}}" + "/" + price;
    ...
    $('#chp52').on('click', function() {
      if ($('#chp52').prop('checked')) {
        var price = $('#chp52').val();
        window.location.href = "{{asset::to('daytours/gridsearch2/')}}" + "/" + price;
    ...
    $('#chp53').on('click', function() {
      if ($('#chp53').prop('checked')) {
        var price = $('#chp53').val();
        window.location.href = "{{asset::to('daytours/gridsearch3/')}}" + "/" + price;
    ...
    $('#chp54').on('click', function() {
      if ($('#chp54').prop('checked')) {
        var price = $('#chp54').val();
        window.location.href = "{{asset::to('daytours/gridsearch4/')}}" + "/" + price;
    ...
    $('#chp55').on('click', function() {
      if ($('#chp55').prop('checked')) {
        var price = $('#chp55').val();
        window.location.href = "{{asset::to('daytours/gridsearch5/')}}" + "/" + price;
    ...
    $('#viewCheckbox1').on('click', function() {
      window.location.href = "{{asset::to('daytours/list')}}";
    });


    $('.countries').on('click', function() {
      var country = $(this).val();
      window.location.href = "{{asset::to('daytours/customsearch/country/')}}" + "/" + country;
    })
    $('#more_countries').hide();
    ...
    $('.categories').on('click', function() {
      ...
      window.location.href = "{{asset::to('daytours/customsearch/category/')}}" + "/" + category;
    })
    ...
    $('.cities').on('click', function() {
      var city = $(this).val();
      window.location.href = "{{asset::to('daytours/customsearch/city/')}}" + "/" + city;
    })
    $('#more_cities').hide();
