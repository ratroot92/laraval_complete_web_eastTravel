...
<div class="col-md-9 " id="searchRendering">
  ...
  <a href="/daytour/detail/{{$item->id}}">
    <div class="col-md-6 col-sm-6 col-xs-12 b_packages wow slideInUp" data-wow-duration="0.5s">
      <!-- OFFER BRAND -->
      <!-- OFFER BRAND -->
      @if($item->disc!=0)<div class="band"> <img src="{{url('/theme/travel')}}/images/icon/ribbon.png" alt="" />
...
var city=$('#chp41').val();
if(city!='NA'){
window.location.href = "{{URL::to('daytours/gridsearch/city/')}}"+"/"+city;
}
else{
}
...
window.location.href = "{{URL::to('daytours/gridsearch/country/')}}"+"/"+country;
...
window.location.href = "{{URL::to('daytours/gridsearch/category/')}}"+"/"+category;
...
var price=$('#chp51').val();
window.location.href = "{{URL::to('daytours/gridsearch1/')}}"+"/"+price;
...
var price=$('#chp52').val();
window.location.href = "{{URL::to('daytours/gridsearch2/')}}"+"/"+price;
...
var price=$('#chp53').val();
window.location.href = "{{URL::to('daytours/gridsearch3/')}}"+"/"+price;
...
var price=$('#chp54').val();
window.location.href = "{{URL::to('daytours/gridsearch4/')}}"+"/"+price;
...
var price=$('#chp55').val();
window.location.href = "{{URL::to('daytours/gridsearch5/')}}"+"/"+price;
...
window.location.href = "{{URL::to('daytours/list')}}";
});


$('.countries').on('click',function(){
var country=$(this).val();
window.location.href = "{{URL::to('daytours/customsearch/country/')}}"+"/"+country;
})
$('#more_countries').hide();
...
window.location.href = "{{URL::to('daytours/customsearch/category/')}}"+"/"+category;
})
...
var city=$(this).val();
window.location.href = "{{URL::to('daytours/customsearch/city/')}}"+"/"+city;
})
$('#more_cities').hide();
