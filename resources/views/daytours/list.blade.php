...
var price=$('#chp51').val();
window.location.href = "{{URL::to('daytours/search1/')}}"+"/"+price;
...
var price=$('#chp52').val();
window.location.href = "{{URL::to('daytours/search2/')}}"+"/"+price;
...
var price=$('#chp53').val();
window.location.href = "{{URL::to('daytours/search3/')}}"+"/"+price;
...
var price=$('#chp54').val();
window.location.href = "{{URL::to('daytours/search4/')}}"+"/"+price;
...
var price=$('#chp55').val();
window.location.href = "{{URL::to('daytours/search5/')}}"+"/"+price;
...
window.location.href = "{{URL::to('/daytours/grid')}}";
});
