...
<strong>PHONE:</strong> +421-917-251-996
    ...
    <!--                <li><a href="#inner-page-title" class="bread-acti">{{$daytour->country ?? '' }}</a>-->
    <!--                </li>-->
    <!--            </ul>-->
    <!--            <h3 style="color: white">{{$daytour->name ?? ''}} </h3>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--</section>-->
    ...
    <!--                <ul>-->
    <!--                    <li class="dl2">Location : {{$daytour->city ?? ''}}, {{$daytour->country ?? '' }}</li>-->
    ...
    <section>
        ...
        <!--        <button type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;"id="Btnpdf" data-task={{$daytour->id ?? ''}}>Download As PDF</button>-->
        <!--    </div>-->
        <!--</div>-->
...
<!--                        </div>-->
                ...
                <!--====== TRIP INFORMATION ==========-->
                    <div class="tour_right tour_incl tour-ri-com">
                        ...
                        <ul>
                            <li>Location : {{$daytour->city ?? ''}}, {{$daytour->country ?? '' }}</li>
                            {{-- <li>Date: {{$daytour->date ?? '' }}</li> --}}
