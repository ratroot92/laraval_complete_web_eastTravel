  @if(count($daytour)>0)
  @foreach($daytour as $key=>$item)
  <a href="/activity/detail/{{$item->id}}">
      <div class="col-md-6 col-sm-6 col-xs-12 b_packages wow slideInUp" data-wow-duration="0.5s">
          <!-- OFFER BRAND -->
          <div class="band" style="top: -10px;"> <img src="{{asset('/theme/travel')}}/images/icon/ribbon.png" alt="" /><span class="disc-text">{{$item->disc}}<br>OFF</span></div>
          <!--<div class="band">-->
          <!--    <div class="box">-->
