...
<!--            <div class="input-field col s12">-->
<!--                <textarea id="about" class="ckeditor" name="about" required="required" >{{$daytour->about}}</textarea>-->
<!--            </div>-->
<!--        </div>-->
...
<div class="row">
    ...
    <div class="input-field col s12 font-weight-bold {{ $errors->has('icons') ? 'has-error' : '' }}">
        ...
        <div class="row">
            <div class="input-field col s12">
              <select name="status" id="status" class="validate" required="required" >
                <option value="0" {{$daytour->status == '0'  ? 'selected' : ''}}>In-active</option>
                <option value="1"  {{$daytour->status == '1'  ? 'selected' : ''}}>Active</option>
              </select>
                <label for="status">daytour Status  </label>
            </div>
        </div>
        ...
        <div class="row">
            <div class="input-field col s12">
                <button type="submit" class="waves-effect waves-light btn-large">Update daytour<i class="fa fa-paper-plane"></i></button>
            </div>
        </div>
    </form>
