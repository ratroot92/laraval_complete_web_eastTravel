...
@section('content')
    <!--====== BANNER ==========-->
    <section>
        <div class="rows inner_banner" style="background-image: url('{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->banner}}');background-size: cover;">
            <div class="container">
                <ul>
                    ...
                    <div class="hotel-book-room">
                        ...
                        <div id="myCarousel1" class="carousel slide" data-ride="carousel">
                            ...
                            <ol class="carousel-indicators carousel-indicators-1">
                                <li data-target="#myCarousel1" data-slide-to="0"><img src="{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->banner}}" alt="banner">
                                </li>
                                <li data-target="#myCarousel1" data-slide-to="1"><img src="{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->img_1}}" alt="img1">
                                </li>
                                <li data-target="#myCarousel1" data-slide-to="2"><img src="{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->img_2}}" alt="img2">
                                </li>
                                <li data-target="#myCarousel1" data-slide-to="3"><img src="{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->img_3}}" alt="img3">
                                </li>
                                <li data-target="#myCarousel1" data-slide-to="4"><img src="{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->img_3}}" alt="img4">
                                </li>
                            </ol>
                            <!-- Wrapper for slides -->
                            <div class="carousel-inner carousel-inner1" role="listbox">
                                <div class="item active"> <img src="{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->banner}}" alt="Chania" width="460" height="345"> </div>
                                <div class="item"> <img src="{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->img_1}}" alt="Chania" width="460" height="345"> </div>
                                <div class="item"> <img src="{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->img_2}}" alt="Chania" width="460" height="345"> </div>
                                <div class="item"> <img src="{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->img_3}}" alt="Chania" width="460" height="345"> </div>
                                <div class="item"> <img src="{{url('/').App\StoragePath::path()}}/storage/events/{{$events[0]->img_4}}" alt="Chania" width="460" height="345"> </div>
                                </div>
