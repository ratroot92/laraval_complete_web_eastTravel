                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12">
                            <div class="file-field">
                                <img src="{{asset('/')}}/storage/events/{{$ev->banner}}" class="img-responsive">
                                <div class="btn">
                        ...
                        <div class="input-field col s12">
                            <div class="file-field">
                                <img src="{{asset('/')}}/storage/events/{{$ev->img_1}}" class="img-responsive">
                                <div class="btn">
                                    <span>File <i class="fa fa-file-image-o"></i></span>
                        ...
                        <div class="input-field col s12">
                            <div class="file-field">
                                <img src="{{asset('/')}}/storage/events/{{$ev->img_2}}" class="img-responsive">
                                <div class="btn">
                                    <span>File <i class="fa fa-file-image-o"></i></span>
                        ...
                        <div class="input-field col s12">
                            <div class="file-field">
                                <img src="{{asset('/')}}/storage/events/{{$ev->img_3}}" class="img-responsive">
                                <div class="btn">
                                    <span>File <i class="fa fa-file-image-o"></i></span>
                        ...
                        <div class="input-field col s12">
                            <div class="file-field">
                                <img src="{{asset('/')}}/storage/events/{{$ev->img_4}}" class="img-responsive">
                                <div class="btn">
                                    <span>File <i class="fa fa-file-image-o"></i></span>
