                ...
                <div class="col-md-12">
                    ...
                    <table id="myTable">
                        ...
                        @foreach($events as $key=>$e)
                            <tr>
                                <td>{{++$key}}</td>
                                <td colspan="2">{{--<img src="{{url('/'.App\StoragePath::path())}}/storage/events/{{$e->banner}}" alt="" />--}}<a href="hotels-list.html" class="events-title">{{$e->name}}</a> </td>
                                <td>{{$e->date}}</td>
                                <td>{{$e->country}}</td>
                                <td>{{$e->city}}</td>
                                <!--<td>{{$e->time}}</td>-->
                    ...
                    <a href="{{route('events.detail',['id'=>$e->id])}}">
                        <div class="col-md-4 col-sm-6 col-xs-12 b_packages wow slideInUp" data-wow-duration="0.5s">
                            ...
                            <div class="v_place_img" style="height: 200px">
                                <img src="{{url('/').App\StoragePath::path()}}/storage/packages/{{$e->banner}}" alt="Tour Booking" title="Tour Booking" style="height: 100%;width: 100%">
                            </div>
                            <!-- TOUR TITLE & ICONS -->
