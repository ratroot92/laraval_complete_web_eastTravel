    ...
    <div class="container-fluid sb1">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-3 col-xs-6 sb1-1">
                ...
                <a href="{{asset('/')}}" class="logo"><img src="{{asset('theme/travel')}}/images/logo.jpg" alt="" />
                </a>
            </div>
            <!--== SEARCH ==-->
            ...
            <div class="col-md-2 col-sm-3 col-xs-6">
                ...
                <a class='waves-effect dropdown-button top-user-pro' href='#' data-activates='top-menu'>
                    {{-- <img src="{{asset('theme/admin')}}/images/user/6.png" alt="" />--}}
                    My Account <i class="fa fa-angle-down" aria-hidden="true"></i>
                </a>

                <!-- Dropdown Structure -->
                <ul id='top-menu' class='dropdown-content top-menu-sty'>
                    <li><a href="{{route('user.setting')}}" class="waves-effect"><i class="fa fa-cogs" aria-hidden="true"></i>Admin Setting</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="{{route('signout')}}" class="ho-dr-con-last waves-effect"><i class="fa fa-sign-in" aria-hidden="true"></i> Logout</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <div class="sb2-1">
                ...
                <div class="sb2-12">
                    <ul>
                        <li>
                            {{-- <img src="{{asset('theme/admin')}}/images/placeholder.jpg" alt="">--}}
                        </li>
                        <li>
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        <li><a href="{{asset('admin/dashboard')}}" class="menu-active"><i class="fa fa-bar-chart" aria-hidden="true"></i> Dashboard</a>
                        </li>
                        ...
                        <li><a href="{{asset('packages/create_update/create/-1')}}">Add New Package</a>
                        </li>
                        <li><a href="{{route('package_cat')}}">All Package Categories</a>
                        </li>
                        <li><a href="{{asset('admin/package_cat/create/-1')}}">Add Package Categories</a>
                        </li>
                    </ul> --}}
                    <ul>
                ...
                <!-- <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella" aria-hidden="true"></i> Activities</a>
                    <div class="collapsible-body left-sub-menu">
                        <ul>
                ...
                <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella" aria-hidden="true"></i> Event</a>
                    <div class="collapsible-body left-sub-menu">
                        <ul>
                            <li><a href="{{route('view.add.event',['action'=>'addEvent'])}}">Add  Event</a>
                            </li>
                ...
                <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella" aria-hidden="true"></i> Cruises</a>
                    <div class="collapsible-body left-sub-menu">
                        <ul>
                ...
                <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella" aria-hidden="true"></i> Transfer</a>
                ...
                {{-- --}}
                <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-picture-o" aria-hidden="true"></i> Day Tours</a>
                    <div class="collapsible-body left-sub-menu">
                        {{-- <ul>
            ...
            <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-ticket" aria-hidden="true"></i> Booking & Enquiry</a>
                <div class="collapsible-body left-sub-menu">
                    <ul>
                        <li><a href="{{asset('inquiries/get/packages')}}">Package</a></li>
                        <li><a href="{{asset('inquiries/get/daytours')}}">Day Tours</a></li>
                        <li><a href="{{asset('inquiries/get/activities')}}">Activities</a></li>
                        <li><a href="{{asset('inquiries/get/events')}}">Events</a></li>
                        <li><a href="{{asset('inquiries/get/cruises')}}">Cruise</a></li>
                        <li><a href="{{asset('inquiries/get/transfers')}}">Transfers</a></li>
                    </ul>
                </div>
            </li>
            <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-rss" aria-hidden="true"></i> Blog & Articals</a>
                <div class="collapsible-body left-sub-menu">
                    <ul>
                        ...
                        <li><a href="{{asset('blogs/create_update/create/-1')}}">Add Blog</a>
                        </li>
                    </ul>
                </div>
            </li>

            <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella" aria-hidden="true"></i> Popular Cities</a>
                <div class="collapsible-body left-sub-menu">
                    <ul>
                        <li><a href="{{route('popularcities.get')}}">All Popular Cities</a>
                        </li>
                        <li><a href="{{asset('popularcities/create_update/create/-1')}}">Add New Popular Cities</a>
                        </li>
            ...
            <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella" aria-hidden="true"></i> Gallery</a>
                <div class="collapsible-body left-sub-menu">
                    <ul>
                        <li><a href="{{asset('/gallery/add')}}">Add Videos</a>
                        </li>
                        <li><a href="{{asset('/gallery/all/videos')}}">All Videos</a>
                        </li>
                        <li><a href="{{asset('/gallery/add_photos')}}">Add Photos </a>
                        </li>
            ...
            <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella" aria-hidden="true"></i> Services</a>
                <div class="collapsible-body left-sub-menu">
                    <ul>
                        <li><a href="{{asset('admin/services/view/vision')}}">Add Service</a>
                        </li>


                        <li><a href="{{asset('admin/services/all/services')}}">All Services</a>
                        </li>
            ...
            <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella" aria-hidden="true"></i> Website Builder</a>
                <div class="collapsible-body left-sub-menu">
                    <ul>
                        <li><a href="{{asset('websitebuilder/terms')}}"> Terms and Conditions</a></li>
                        <li><a href="{{asset('websitebuilder/cancellations')}}">>Cancellation Policy</a></li>
                        <li><a href="{{asset('websitebuilder/contactus')}}"> Contact Us</a></li>
                        <li><a href="{{asset('websitebuilder/cookies')}}"> Cookies Policy</a></li>
                        <li><a href="{{asset('websitebuilder/paymentpolicy')}}"> Payment Policy</a></li>
                        <li><a href="{{asset('websitebuilder/faq')}}">FAQs</a></li>
                        <li><a href="{{asset('websitebuilder/aboutus')}}">About Us</a></li>
            ...
            <li>
                <br>
                <a href="{{route('signout')}}" class="alert alert-danger"><i class="fa fa-sign-in" aria-hidden="true"></i> Logout</a>
            </li>
            </ul>
        </div>
    </div>
