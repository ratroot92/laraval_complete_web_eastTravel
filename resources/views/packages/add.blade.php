...
<div class="bor">
    <form method="post" enctype="multipart/form-data" action="{{route('package.insert')}}">
        {{csrf_field()}}
...
<!--        </div>-->
 ...
 <div class="row">
    <span class="alert alert-info ">select which icons should be visible in list view  </span>
        ...
        <div class="row">
            <div class="input-field col s12 font-weight-bold">
                <button type="submit" class="waves-effect waves-light btn-large">Create package<i class="fa fa-paper-plane"></i></button>
            </div>
        </div>
    </form>
