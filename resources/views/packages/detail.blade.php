...
@section('content')
    <!--====== BANNER ==========-->
    <section>
        <div class="rows inner_banner" style="background-image: url('{{$package->banner}}');background-size: cover;">
            <!--<div class="container">-->
            <!--    <ul>-->
            ...
            <!--        </li>-->
            <!--    </ul>-->
            <!--    <h3 style="color: white">{{$package->name}} | @foreach($categories as $item){{$item->name}}/@endforeach</h3>-->
            <!--</div>-->
        </div>
    </section>
...
@endif
   ...
   <!--                 </div>-->
                    ...
                    <div class="row">
                        ...
                        @php echo  $package->questions@endphp
                    </div>
                    <!-- <div class="row p-t-10">
                       <div class="col-md-12">
                          <a type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;font-size:12px;"id="Btnpdf" href="{{URL::to('/package/downloadPDF/').'/'.$package->id}}">Download As PDF</a>
                       </div>
                    </div> -->
                    <!--====== TOUR LOCATION ==========-->
                ...
                <div class="col-md-4 col-md-pull tour_r">
                    ...
                    <div class="tour_right ">
                        ...
                        <div class="col-sm-6" style="padding: 1px;">
                            <a type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;font-size:12px;width:100%;"id="Btnpdf" href="{{URL::to('/packages/downloadPDF/').'/'.$package->id}}">Download PDF</a>
                        </div>
                    </div>
                ...
                <!--====== TRIP INFORMATION ==========-->
                    <div class="tour_right tour_incl tour-ri-com">
                        ...
                        <ul>
                            <li>Tour Code: @php echo  $package->tourcode@endphp</li>
                            ...
                            <li>Group Size: @php echo  $package->grpsize@endphp</li>
                            <li>Tour Style: @php echo  $package->tourstyle@endphp</li>
                            <li>Tour Language: @php echo  $package->tourlanguage@endphp</li>
                            <li>Start/End Location: @php echo  $package->startloc@endphp</li>
                            <li>Availablity: @php echo  $package->avalibilitydetails@endphp</li>
                            <li>Transport Details: @php echo  $package->tranportdetails@endphp</li>
                            <li>Accomodation Details: @php echo  $package->accomodationdetails@endphp</li>
                            <li>Meal Details: @php echo  $package->mealdetails@endphp</li>
                            <li>Guide Details: @php echo  $package->guidedetails@endphp</li>
                            </ul>
                    </div>
            ...
            <!--                        <td>Tour Code</td>-->
            <!--                        <td>:</td>-->
            <!--                        <td>@php echo  $package->tourcode@endphp</td>-->
            <!--                    </tr>-->
            <!--                    <tr>-->
            <!--                        <td>Location</td>-->
            <!--                        <td>:</td>-->
...
<!-- The Modal -->
  <div class="modal" id="emailenquiry">
   ...
   <form action="{{ url('package/detail_inquiry ') }}" method="post">
  {{csrf_field()}}
  <input type="hidden" name="event_name" value="package" />
    <input type="hidden" name="event_id" value="{{ $package->id }}" />
