...
var city=$('#chp41').val();
if(city!='NA'){
window.location.href = "{{URL::to('packages/gridsearch/city/')}}"+"/"+city;
}
else{
}
...
window.location.href = "{{URL::to('packages/gridsearch/country/')}}"+"/"+country;
...
window.location.href = "{{URL::to('packages/gridsearch/category/')}}"+"/"+category;
...
var price=$('#chp51').val();
window.location.href = "{{URL::to('packages/gridsearch1/')}}"+"/"+price;
...
var price=$('#chp52').val();
window.location.href = "{{URL::to('packages/gridsearch2/')}}"+"/"+price;
...
var price=$('#chp53').val();
window.location.href = "{{URL::to('packages/gridsearch3/')}}"+"/"+price;
...
var price=$('#chp54').val();
window.location.href = "{{URL::to('packages/gridsearch4/')}}"+"/"+price;
...
var price=$('#chp55').val();
window.location.href = "{{URL::to('packages/gridsearch5/')}}"+"/"+price;
...
window.location.href = "{{URL::to('/packages/list')}}";
});
