          ...
          <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
            <form>
              <div id="cities">
                <ul class="" >
                 <li>
                               <a href="/packages/list" style="padding:0px!important;margin:0px!important;color:white; border:none;">
          ...
          <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
            <form>
              <div id="countries">
                <ul class="" >
                  <li>
                                <a href="/packages/list" style="padding:0px!important;margin:0px!important;color:white; border:none;"> <div class="checkbox checkbox-info checkbox-circle">
