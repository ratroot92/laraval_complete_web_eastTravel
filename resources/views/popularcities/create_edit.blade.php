...
<div class="sb2-2">
    ...
    <div class="sb2-2-add-blog sb2-2-1">
        <div class="box-inn-sp">
            ...
            <div class="bor">
                <form method="post" enctype="multipart/form-data" action="{{asset("popularcities/$action/$id")}}">
                    {{csrf_field()}}
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12">
                            <div class="file-field">
                                ...
                                @if($action == 'update')
                                <div class="col-sm-3">
                                    <img class="img-thumbnail img-responsive" src="{{asset(App\StoragePath::path().'/storage/popularcities/'.$popularcities_data[0]->banner)}}" alt="">
                                </div>
