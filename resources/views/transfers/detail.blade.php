...
@endif
                    ...
                    {{--<div class="tour_head1 l-info-pack-days days">
                        ...
                        <ul>
                            <li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
                                <h4><span>Day : 1</span> Arrival and Evening Dhow transfer</h4>
                                <p>Arrive at the airport and transfer to hotel. Check-in time at the hotel will be at 2:00 PM. In the evening, enjoy a tasty dinner on the Dhow transfer. Later, head back to the hotel for a comfortable overnight stay.</p>
                            </li>
                            <li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
                                <h4><span>Day : 2</span> City Tour and Evening Free for Leisure</h4>
                                <p>After breakfast, proceed for tour of Dubai city. Visit Jumeirah Mosque, World Trade Centre, Palaces and Dubai Museum. Enjoy your overnight stay at the hotel.In the evening, enjoy a tasty dinner on the Dhow transfer. Later, head back to the hotel for a comfortable overnight stay.</p>
                            </li>
                            <li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
                            ...
                            <li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
                                ...
                                <p>Savour a satiating breakfast and relax for a while. Day Free for leisure. Overnight stay will be arranged in Dubai. In the evening, enjoy a tasty dinner on the Dhow transfer. Later, head back to the hotel for a comfortable overnight stay.</p>
                            </li>
                            <li class="l-info-pack-plac"> <i class="fa fa-clock-o" aria-hidden="true"></i>
                                <h4><span>Day : 5</span> Departure</h4>
                                <p>Fill your tummy with yummy breakfast and relax for a while. Later, check out from the hotel and proceed for your onward journey.In the evening, enjoy a tasty dinner on the Dhow transfer. Later, head back to the hotel for a comfortable overnight stay.</p>
                            </li>
                        </ul>
                    </div>
                    <div>
                ...
                <div class="col-md-4 col-md-pull tour_r">
                    ...
                    <div class="tour_right ">
                        ...
                        <div class="col-sm-6" style="padding: 1px;">
                             <a type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;font-size:12px;width: 100%;"id="Btnpdf" href="{{URL::to('/transfers/downloadPDF/').'/'.$transfer->id}}">Download PDF</a>
                        </div>
                    </div>
  ...
  <div class="modal" id="emailenquiry">
    <div class="modal-dialog">
      <div class="modal-content">
       ...
       <form action="{{ url('transfer/detail_inquiry ') }}" method="post">
  {{csrf_field()}}
  <input type="hidden" name="event_name" value="transfer" />
    <input type="hidden" name="event_id" value="{{ $transfer->id }}" />
