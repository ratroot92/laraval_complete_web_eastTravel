                    ...
                    <form class="row" action="{{asset('search/result')}}">
                        ...
                        <div class="col-sm-8 col-lg-8" class="autocomplete" style="padding: 0px;margin: 0px">
                            ...
                            <div style="text-align: left;width:100%;background-color:white!important;position: absolute; z-index:99;    padding: 10px 10px;" id="search_div">
                                <a href="/">
                                    <h2 style="color: #253d52; padding-left: 15px;margin: 0;">Popular <span style="color: #f4364f;font-size: 2rem;">Cities</span></h2>
                                </a>
    ...
    <div class="rows tb-spaces pad-top-o pad-bot-redu">
        <div class="container-fluid">
            ...
            <div class="col-md-3">
                ...
                <div class="tour-mig-like-com">
                    <div class="tour-mig-lc-img">
                        ...
                        {{--<img src="{{asset('/theme/travel')}}/images/listing/home.jpg" alt="">--}} </div>
            ...
            <div class="col-md-3">
                ...
                <div class="tour-mig-like-com">
                    <div class="tour-mig-lc-img">
                        ...
                        {{--<img src="{{asset('/theme/travel')}}/images/listing/home3.jpg" alt="">--}}
                    </div>
            ...
            <div class="col-md-3">
                ...
                <div class="tour-mig-like-com">
                    <div class="tour-mig-lc-img">
                        {{-- <img src="{{asset('/theme/travel')}}/images/listing/home2.jpg" alt="">--}}
