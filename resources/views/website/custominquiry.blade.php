...
<div class="container">
    <div class="cus-book-form form_1">
        <form class="contact__form v2-search-form" method="post" action="{{asset('/submitinquiry_email')}}">
            @csrf
            ...
            <div class="row ">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="terms" style="font-size: 9px;"><b>I have read and agree</b> to the <a href="{{asset('/termscondition')}}">Terms & conditions</a>, <a href="{{asset('/payment/policy')}}">Personal data processing</a> and <a href="{{asset('/payment/policy')}}">Privacy Policy</a></a>.</label>
                </div>
                <br>
                <!-- Material inline 2 -->
                <div class="form-check form-check-inline">
