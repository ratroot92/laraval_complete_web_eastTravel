...
<div class="sb2-2">
    ...
    <div class="sb2-2-add-blog sb2-2-1">
        <div class="box-inn-sp">
            ...
            <div class="bor">
                <form method="post" action="{{asset('websitebuilder/updateTerms')}}">
                    {{csrf_field()}}

                    <div class="row">
                        <br>
                        <label for="textarea1" style="color:red;font-weight:bold;font-size:14px;">UPDATE BASIC TERM CONDITIONS</label>
                        <div class="input-field col s12">
                            <textarea id="content" class="ckeditor" name="content" required="required">{{$content->terms}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <button type="submit" class="waves-effect waves-light btn-large">UPDATE BASIC TERM CONDITIONS <i class="fa fa-paper-plane"></i></button>
                        </div>
                    </div>
                </form>
